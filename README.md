...
| PostgreSQL 迁移 | 进行中 | 目标预检、连接/SQL 方言、事务锁及版本 14 PostgreSQL schema 基线 |
| 自动化验证 | 已完成 | 168 项测试、82% 分支覆盖率、20 年历史性能基准和 GitHub Actions |
...
PostgreSQL 迁移正在分阶段推进。当前 API 仍只支持 SQLite；迁移状态、预检命令和
已识别兼容点见 [PostgreSQL 迁移手册](docs/POSTGRESQL_MIGRATION.md)。
